#############################################################################
# Makefile for building: tests_checker.app/Contents/MacOS/tests_checker
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Sep 24 10:15:13 2014
# Project:  tests_checker.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile tests_checker.pro
#############################################################################
...
SOURCES       = tests_checker.cpp \
		utc.cpp moc_utc.cpp
OBJECTS       = tests_checker.o \
		utc.o \
		moc_utc.o
DIST          = /usr/local/Cellar/qt/4.8.6/mkspecs/common/unix.conf \
		...
		tests_checker.pro
QMAKE_TARGET  = tests_checker
DESTDIR       = 
TARGET        = tests_checker.app/Contents/MacOS/tests_checker
...
all: Makefile tests_checker.app/Contents/PkgInfo tests_checker.app/Contents/Resources/empty.lproj tests_checker.app/Contents/Info.plist $(TARGET)

$(TARGET): ui_utc.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) tests_checker.app/Contents/MacOS/ || $(MKDIR) tests_checker.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: tests_checker.pro  /usr/local/Cellar/qt/4.8.6/mkspecs/unsupported/macx-clang/qmake.conf /usr/local/Cellar/qt/4.8.6/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/clang.conf \
	...
	$(QMAKE) -o Makefile tests_checker.pro
...
tests_checker.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) tests_checker.app/Contents || $(MKDIR) tests_checker.app/Contents 
	@$(DEL_FILE) tests_checker.app/Contents/PkgInfo
	@echo "APPL????" >tests_checker.app/Contents/PkgInfo
tests_checker.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) tests_checker.app/Contents/Resources || $(MKDIR) tests_checker.app/Contents/Resources 
	@touch tests_checker.app/Contents/Resources/empty.lproj
	
tests_checker.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) tests_checker.app/Contents || $(MKDIR) tests_checker.app/Contents 
	@$(DEL_FILE) tests_checker.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,tests_checker,g" -e "s,@TYPEINFO@,????,g" /usr/local/Cellar/qt/4.8.6/mkspecs/unsupported/macx-clang/Info.plist.app >tests_checker.app/Contents/Info.plist
dist: 
	@$(CHK_DIR_EXISTS) .tmp/tests_checker1.0.0 || $(MKDIR) .tmp/tests_checker1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/tests_checker1.0.0/ && $(COPY_FILE) --parents utc.h .tmp/tests_checker1.0.0/ && $(COPY_FILE) --parents tests_checker.cpp utc.cpp .tmp/tests_checker1.0.0/ && $(COPY_FILE) --parents utc.ui .tmp/tests_checker1.0.0/ && (cd `dirname .tmp/tests_checker1.0.0` && $(TAR) tests_checker1.0.0.tar tests_checker1.0.0 && $(COMPRESS) tests_checker1.0.0.tar) && $(MOVE) `dirname .tmp/tests_checker1.0.0`/tests_checker1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/tests_checker1.0.0
...
compiler_moc_header_make_all: moc_utc.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_utc.cpp
moc_utc.cpp: ui_utc.h \
		utc.h
	/usr/local/Cellar/qt/4.8.6/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ utc.h -o moc_utc.cpp
...
compiler_uic_make_all: ui_utc.h
compiler_uic_clean:
	-$(DEL_FILE) ui_utc.h
ui_utc.h: utc.ui
	/usr/local/Cellar/qt/4.8.6/bin/uic utc.ui -o ui_utc.h
...
tests_checker.o: tests_checker.cpp utc.h \
		ui_utc.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tests_checker.o tests_checker.cpp

utc.o: utc.cpp utc.h \
		ui_utc.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o utc.o utc.cpp

moc_utc.o: moc_utc.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_utc.o moc_utc.cpp
